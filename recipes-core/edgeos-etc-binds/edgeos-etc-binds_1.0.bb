...
SRC_URI = " \
    file://edgeos-etc-binds.service \
    file://setup-etc-binds.sh \
    "

SYSTEMD_SERVICE:${PN} = "edgeos-etc-binds.service"
...
do_install() {
    ...
    install -m 0644 ${WORKDIR}/edgeos-etc-binds.service ${D}${systemd_system_unitdir}/
...
FILES:${PN} += "${systemd_system_unitdir}/edgeos-etc-binds.service"
